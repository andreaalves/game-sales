![gamesales_white](https://user-images.githubusercontent.com/103602522/177585191-ebb4d03d-4276-4344-a5a8-4f3abdf5f4f3.png)


# Game Sales Dash

Dashboard para análise de vendas de video games (1980-2017) feito com Python.

## 🔧 Funções

- Ler e dispor dados de forma visual a partir do dataset
- Filtrar por ano os dados para uma análise mais minuciosa
- RangeSlider para um filtro de data específico
...
<a href = "https://gamesales-dash.herokuapp.com/"><img src="https://img.shields.io/badge/ASIMOV-Projeto%20em%20tempo%20real-lightgrey" target="_blank"></a> 
...
# game-sales
Dashboard de análise de vendas de jogos de 1980 a 2017
